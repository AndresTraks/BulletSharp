...
namespace ConcaveRaycastDemo
{
    ...
    class RaycastBar
    {
        static readonly int NUMRAYS_IN_BAR = 100;
	    ...
	    public void Cast (CollisionWorld cw)
	    {
		    ...
		    if (frame_counter > 50)
		    {
			    ...
			    Console.WriteLine("%d rays in %d ms %d %d %f", NUMRAYS_IN_BAR * frame_counter, ms, min_ms, max_ms, mean_ms);
			    ms = 0;
			    frame_counter = 0;
		    }
#endif
    ...
    class ConcaveRaycastDemo : Demo
    {
        ...
        DebugDrawModes debugMode = DebugDrawModes.None;
