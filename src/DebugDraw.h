...
namespace BulletSharp
{
	...
	public ref class DebugDraw abstract
	{
		internal:
		...
		public:
...
#if GRAPHICS_XNA31
			virtual void DrawLine(Vector3 from, Vector3 to, Color color) abstract;
			...
			virtual void DrawLine(Vector3 from, Vector3 to, Color4 color) abstract;
