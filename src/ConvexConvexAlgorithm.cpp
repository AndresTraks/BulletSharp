...
ConvexConvexAlgorithm::CreateFunc::CreateFunc(ConvexPenetrationDepthSolver^ pdSolver)
	: CollisionAlgorithmCreateFunc(new btConvexConvexAlgorithm::CreateFunc(pdSolver->_native), false)
{
	_pdSolver = pdSolver;
}
...
ConvexConvexAlgorithm::ConvexConvexAlgorithm(PersistentManifold mf, CollisionAlgorithmConstructionInfo^ ci,
	CollisionObjectWrapper^ body0Wrap, CollisionObjectWrapper^ body1Wrap, ConvexPenetrationDepthSolver^ pdSolver,
	...
	: ActivatingCollisionAlgorithm(new btConvexConvexAlgorithm(mf._native,
		*ci->_native, body0Wrap->_native, body1Wrap->_native, pdSolver->_native,
